...
dataset_train = L(DataLoader)(
	dataset=L(CocoDetection)(
		img_folder="./data/coco/train/images",
		ann_file="./data/coco/train/coco_instances.json",
...
dataset_val = L(DataLoader)(
	dataset=L(CocoDetection)(
		img_folder="./data/coco/val/images",
		ann_file="./data/coco/val/coco_instances.json",
		transforms=L(Compose)(
